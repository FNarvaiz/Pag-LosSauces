...
function renderChangePasswordDialog
  ...
  <div id="loginDialogImg"><img src="front-end/resource/login.jpg" onload="document.getElementById('main').style.visibility = 'visible'; document.changePasswordForm.pwd.focus();"></div>
  <%
end function
...
function doChangePassword
  ...
  <div id="loginDialogImg"><img src="front-end/resource/login.jpg" onload="document.getElementById('main').style.visibility = 'visible';"></div>
  <%
end function
...
function renderRegistrationDialog
  ...
  <div id="loginDialogImg"><img src="front-end/resource/login.jpg" onload="document.getElementById('main').style.visibility = 'visible'; document.registrationForm.unit.focus();"></div>
  <%
end function
...
function sendRegistrationMessage(unit, name, email)
  ...
  dim message: message = "<table border=1>" & _
    ...
    "</table>"
  sendMail "Altas - Vecinos de los Sauces", "info@vecinosdelossauces.com.ar", "Alta de Unidad/lote: " & unit, message, name, email
end function
...
function renderPasswordRecoveryDialog
  ...
  <div id="loginDialogImg"><img src="front-end/resource/login.jpg" onload="document.getElementById('main').style.visibility = 'visible'; document.passwordRecoveryForm.usr.focus();"></div>
  <%
end function
