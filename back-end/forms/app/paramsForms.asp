...
function formAdminParams
  ...
  forms = array("formTimelineCategories","formCommissions", "formSuppliersCategories", "formSurveysCategories", "formClassifiedsCategories")
  childFormIds = "formTimelineCategories,formCommissions,formSuppliersCategories,formSurveysCategories,formClassifiedsCategories"
end function
...
function formTimelineCategories
  ...
  recordViewFields = array("ID", "NOMBRE", "VIGENTE", "MOSTRAR", "SOLO_ADMINISTRACION")
  recordViewDBFields = array(true, true, true, true, true)
  recordViewReadOnlyFields = array(not nullRecord and recordId <= 6, false, false, false, false)
  recordViewFieldLabels = array("Código", "Nombre", "Vigente", "Cartelera", "Administración")
  recordViewFieldDefaults = array(null, null, true, true, false)
  recordViewNullableFields = array(false, false, false, false, false)
  recordViewFieldRenderFuncs = array("renderRecordViewNumericField", "renderRecordViewLiteralField", _
    "renderRecordViewBooleanField", "renderRecordViewBooleanField", "renderRecordViewBooleanField")
end function
